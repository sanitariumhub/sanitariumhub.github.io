...
$con=mysqli_connect("localhost","root","","hms");
  ...
  $pid = isset($_SESSION['pid']);
  $username = isset($_SESSION['username']);
  $email = isset($_SESSION['email']);
  $fname = isset($_SESSION['fname']);
  $gender = isset($_SESSION['gender']);
  $lname = isset($_SESSION['lname']);
  $contact = isset($_SESSION['contact']);
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Sanitarium Hub</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="/admin-panel.php"><img src="logo.jpg" alt="" style="width:50px;"> Sanitarium Hub </a>
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="home">Appointment</a>
      ...
      <a class="list-group-item list-group-item-action" href="#blood-group" id="list-blood-group" role="tab" data-toggle="list" aria-controls="home">Blood Group</a>
            ...
            <div class="row">
              ...
              <div class="col-sm-4" style="left: 20%;margin-top:5%">
                <div class="panel panel-white no-radius text-center">
                  <div class="panel-body" >
                    <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-list-ul fa-stack-1x fa-inverse"></i> </span>
                    <h4 class="StepTitle" style="margin-top: 5%;">Blood Group</h2>
                  
                    <p class="cl-effect-1">
                      <a href="#blood-group" onclick="clickDiv('#list-blood-group')">
                        View Blood Group
                      </a>
                    </p>
                  </div>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <div class="tab-pane fade" id="blood-group" role="tabpanel" aria-labelledby="list-blood-group">
        ...
        <table class="table table-hover">
          ...
          <tbody>
            <?php 
              ...
              $query = "SELECT fname, lname, bloodgroup FROM patreg";
