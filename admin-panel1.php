...
<html lang="en">
  ...
  <a class="navbar-brand" href="/admin-panel1.php"> <img src="logo.jpg" alt="" style="width:50px"> Sanitarium Hub </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-blood" id="list-blood-group"  role="tab" data-toggle="list" aria-controls="home">Blood Group</a>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
              ...
              <div class="row">
               <div class="col-sm-4">
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-heart fa-stack-2x text-primary"></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Blood Group</h4>
                    
                      <p class="cl-effect-1">
                        <a href="#list-blood" onclick="clickDiv('#list-blood-group')">Blood Group</a>
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div class="tab-pane fade" id="list-blood" role="tabpanel" aria-labelledby="list-blood-group">
      
      <h3 style="text-align:center; margin-bottom:20px;">Blood Group List</h3>
      ...
      <table class="table table-hover">
          ...
          <tbody>
            <?php 
              ...
              $query = "SELECT fname, lname, bloodgroup, contact FROM patreg";
