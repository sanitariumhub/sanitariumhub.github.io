<?php
session_start();
$conn = mysqli_connect("localhost", "root", "", "hms") or die("Connection Failed:" . mysqli_error());
...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="INSERT INTO patreg (fname, lname, gender, email, contact, bloodgroup, password, cpassword) 
            VALUES ('$fname','$lname','$gender','$email','$contact', '$bloodgroup', '$password', '$cpassword')";
